                                        ...
                                        <tbody>
                                            <?php foreach ($eggrafes as $b) :?>
                                              <tr>
                                                  ...
                                                  <td class="center">
                                                      <a style="margin: 5px;" class="btn btn-warning"  title="Προβολή" href="<?php echo MY_FILEFOLDER.$b->upload_file;?>">
                                                            <i class="fa fa-download"></i>                                            
                                                      </a>
                                                      <a class="btn btn-danger" style="margin: 5px;"  href="/backend/school/delete/<?php echo $ontotita->id;?>/<?php echo $b->id;?>" onclick="return confirm('Eίστε σίγουροι για την διαγραφή;')" title="Διαγραφή">
