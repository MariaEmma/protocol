                                    ...
                                    <div class="col-md-6"> 
                                        ...
                                        <?php echo form_input(array(
                                          ...
                                          <?php if ($this->session->userdata('usertype') !=1) { ?>
                                            <?php 
                                            $ret['ontotita2'] = $ontotita2;
                                            $this->load->view('users/usubview',$ret); ?>
                                         <?php } else { ?> 
                                        <?php if($ontotita2->usertype_id == 1 || $ontotita2->usertype_id == 3 || $ontotita2->usertype_id == 4){ ?>
                                         <?php 
                                            $ret['ontotita2'] = $ontotita2;
                                            $this->load->view('users/usubview',$ret); ?>
                                            <?php } else {?>  
                                        <div class="form-group"> 
                                              ...
                                              <?php $js = 'id = "usertypeid" name="usertype_id" tabindex = "4" class="form-control" onchange="return onSelectChange();" value ="'.$ontotita2->usertype_id.'"';
